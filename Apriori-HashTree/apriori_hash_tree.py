...
def apriori_student(df, dataset, te_array, min_support=0.6):
    ...
    print("dataset:",dataset)
    print("te_array:",te_array)
    mapping = num2Id(dataset, te_array)
    print("mapping:",mapping)
    print("all_frequent:",all_frequent)
...
if __name__=='__main__':
    ...
    # candidate = [(1,2,5),(1,2,5),(4,5,7),(1,2,7)]
    # htree = HashTree(3, 3)
    # htree.build_tree(candidate)
    # print(htree.root.bucket)
    # print(htree.root.children)
    # print(htree.freq_itemsets(htree.root, 0.2, [], []))
